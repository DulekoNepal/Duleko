...
function TermsContent({ lang }: { lang: "en" | "ne" }) {
  ...
  return (
    <div>
      <p className={body}>
        {lang === "ne"
          ? "डुलेको एउटा प्लेटफर्म हो जसले मानिसहरूलाई सीप र स्थानीय काम अवसरहरूको वरिपरि फेला पार्न, प्रस्ताव गर्न, र जोडिन मद्दत गर्छ। खाता खोलेर, तपाईं तलका कुराहरूमा सहमत हुनुहुन्छ।"
...
function TermsFullNe() {
  return (
    <>
      ...
      <p className={body}>
        डुलेको आफैं प्लेटफर्ममा सूचीबद्ध प्रयोगकर्ताहरूको रोजगारदाता होइन, र स्पष्ट रूपमा अन्यथा नभनिएसम्म, प्रयोगकर्ताहरू
      ...
      <p className={body}>
        प्रयोगकर्ताले आफूले गर्न सक्ने सीपहरू सूचीबद्ध गर्न सक्छन्। डुलेकोमा कुनै सीप सूचीबद्ध गर्नु मात्रले डुलेकोले त्यो
        सीप प्रमाणित गरेको जनाउँदैन। डुलेको, नगरपालिका, तालिम संस्था, वा अन्य अधिकृत संस्थाले कुनै प्रमाणपत्र वा योग्यता
      ...
      <p className={body}>
        प्रयोगकर्ताले डुलेको मार्फत एकआपसमा सम्पर्क गरी काम मिलाउन सक्छन्। डुलेकोले स्पष्ट रूपमा अन्यथा नभनेसम्म,
        कामदार र काम दिनेले काम, स्थान, समय, मूल्य वा ज्याला, भुक्तानी विधि, र अन्य सर्तहरूमा सहमत हुने जिम्मेवारी
        लिन्छन्।
      </p>
      <p className={body}>
        डुलेकोले कुनै प्रयोगकर्तालाई काम पाउने, कामदारले सन्तोषजनक रूपमा काम गर्ने, वा अर्को प्रयोगकर्ताले भुक्तानी
      ...
      <p className={body}>
        ...
        डुलेकोले पछि एकीकृत भुक्तानी सेवा नल्याएसम्म, भुक्तानी सिधै प्रयोगकर्ताहरू बीच हुन्छ, र डुलेकोले त्यस्ता
      ...
      <p className={body}>
        ...
        झल्काउनुपर्छ। नक्कली, आपत्तिजनक, भेदभावपूर्ण, धम्कीपूर्ण, वा जानाजानी भ्रामक समीक्षा हटाइन सक्छ। डुलेकोले
      ...
      <p className={body}>
        डुलेको ठगी, दुर्व्यवहार, धम्की, शोषण, भेदभाव, गैरकानूनी गतिविधि, भ्रामक प्रस्तुति, वा अन्य प्रयोगकर्तालाई
        खतरामा पार्न सक्ने गतिविधिको लागि प्रयोग गर्नु हुँदैन। शंकास्पद वा असुरक्षित गतिविधिको जानकारी दिनुपर्छ।
        प्रयोगकर्ता वा प्लेटफर्मको सुरक्षाको लागि उचित रूपमा आवश्यक परेमा डुलेकोले उजुरीको छानबिन गरी खाता प्रतिबन्ध,
...
function PrivacyFullNe() {
  return (
    <div>
      ...
      <p className={body}>प्रयोगकर्ताले प्रयोग गर्ने सुविधाहरूको आधारमा, डुलेकोले निम्न सङ्कलन गर्न सक्छ:</p>
      <ul className={list}>
        ...
        <li>प्राविधिक जानकारी: सुरक्षा, प्रमाणीकरण, समस्या समाधान, र डुलेकोको सञ्चालनको लागि उचित रूपमा आवश्यक जानकारी।</li>
      </ul>
      <p className={body}>
        नेपालको गोपनीयता ऐनले व्यक्तिगत जानकारी र गोपनीयतालाई स्पष्ट रूपमा नियमन गर्छ, त्यसैले डुलेकोले यस्तो डेटाको
      ...
      <p className={body}>डुलेकोले जानकारी निम्न उद्देश्यका लागि प्रयोग गर्न सक्छ:</p>
      <ul className={list}>
      ...
      <p className={body}>
        केही जानकारी अन्य डुलेको प्रयोगकर्ता वा भ्रमणकर्तालाई देखिने गरी राखिन्छ, जस्तै नाम, प्रोफाइल फोटो, सीप,
      ...
      <p className={body}>
        प्रयोगकर्ताको मोबाइल नम्बर खाता प्रमाणीकरण र सञ्चारको लागि सङ्कलन गरिन्छ। डुलेकोले फोन नम्बर अज्ञात
        भ्रमणकर्तालाई खुला रूपमा उपलब्ध गराउँदैन। डुलेकोले प्रयोगकर्तालाई एकआपसमा फोन गर्न वा सम्पर्क गर्न दिने
        ठाउँमा, पहुँच डुलेकोको खाता र गोपनीयता नियन्त्रण अनुसार हुन्छ।
      </p>
      ...
      <p className={body}>
        ...
        देखाइन्छ। डुलेकोले लाइभ-स्थान साझेदारी उपलब्ध गराएमा, प्रयोगकर्ताले जानीजानी त्यो सक्रिय गर्छ र जुनसुकै बेला
        रोक्न सक्छ।
      </p>
      ...
      <p className={body}>
        ...
        डुलेकोले निम्न जस्तो चिन्ह देखाउन सक्छ:
      </p>
      <div className="my-2 flex flex-wrap gap-2">
        <Badge tone="success">तालिम प्रमाणित</Badge>
        <Badge tone="neutral">नगरपालिका वा तालिम संस्थाद्वारा प्रमाणित</Badge>
      </div>
      <p className={body}>डुलेकोले यस उद्देश्यका लागि उचित रूपमा आवश्यक प्रमाणीकरण जानकारी मात्र सङ्कलन र सुरक्षित राख्छ।</p>

      <h3 className={heading}>७. जानकारी साझेदारी</h3>
      <p className={body}>
        डुलेकोले प्रयोगकर्ताको व्यक्तिगत जानकारी बेच्दैन। जानकारी डुलेको सञ्चालनको लागि उचित रूपमा आवश्यक भएमा,
        प्रयोगकर्ताले साझेदारीको अनुमति दिएमा, उपयुक्त सुरक्षा उपायसहित प्लेटफर्म सञ्चालनको लागि आवश्यक सेवा
        प्रदायकसँग, वा लागू कानूनले खुलासा आवश्यक गरेमा मात्र साझा गरिन्छ। डुलेकोसँग साझेदारी गर्ने नगरपालिकाले
        प्लेटफर्ममा मानिसहरूलाई बढावा वा प्रमाणित गरेको कारणले मात्र व्यक्तिगत प्रयोगकर्ताको निजी जानकारी स्वतः
        पाउँदैन।
      </p>
      <p className={body}>प्रतिवेदनको उद्देश्यका लागि, डुलेकोले निम्न जस्तो सारांशित जानकारी साझा गर्न रुचाउँछ:</p>
      <ul className={list}>
      ...
      <p className={body}>
        डुलेकोले व्यक्तिगत जानकारीलाई अनधिकृत पहुँच, खुलासा, परिवर्तन, हानि, वा दुरुपयोगबाट जोगाउन उचित प्राविधिक र
      ...
      <p className={body}>
        प्लेटफर्मको विकास वा कानूनी आवश्यकता परिवर्तन भएअनुसार डुलेकोले यो गोपनीयता नीति अद्यावधिक गर्न सक्छ।
